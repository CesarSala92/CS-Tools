...
from Autodesk.Revit.DB import ElementId, CategoryType, FilteredElementCollector, BuiltInCategory, DetailLine
...
if inicio:
    ...
    filtro = FilteredElementCollector(doc).OfCategory(BuiltInCategory.OST_Lines).ToElements()
    salida = []
    for i in rectangulo:
        if isinstance(i, DetailLine):
            salida.append(i)
